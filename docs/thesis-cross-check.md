...
- Archivo local: `[Tesis2][20201315][Flores][Amir] (4) (1).pdf`
...
El PDF completo no se copió al repositorio para evitar añadir 42 MiB y datos
personales innecesarios. Este documento resume sólo la información técnica
usada en la comparación. Las páginas citadas son las impresas en la tesis.
...
`mega2560/source-candidate/firmware-string-comparison.json`.

...
`tesis-mega2560/tesis-mega2560.ino` fue extraído sin modificaciones del ZIP
`FINAL_FINAL_FINAL_TESIS_AMIR_FLORES.zip` entregado el 5 de septiembre de 2026.
El archivo se llamaba originalmente `FINAL_FINAL_FINAL_TESIS_AMIR_FLORES.ino`;
sólo se renombró para cumplir la convención de sketches de Arduino, donde la
carpeta y el archivo principal comparten nombre.
...
Los offsets y bytes exactos están en `../analysis/firmware-string-comparison.json`. Esta
...
defectos están documentados en `../../docs/comparacion-tesis-firmware.md`; no se corrigieron
